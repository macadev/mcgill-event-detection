# Note to reader: this is class is provided by opencv-2.4.3/samples/python2/find_obj.py
# forked on 160118 - 23:42

# adjustements will be made to repurpose
#
#   from
#        < frame : frame > comparisons
#   to 
#        < video : frame > comparisons
